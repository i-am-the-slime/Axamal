...
public class XmlPackageImpl extends EPackageImpl implements XmlPackage {
	 ...
	 * @generated
	 */
	public EReference getNode_HasAttr() {
	...
	public void createPackageContents() {
		...
		createEReference(nodeEClass, NODE__HAS_ATTR);
		createEReference(nodeEClass, NODE__SUBNODES);
	...
	public void initializePackageContents() {
		...
		initEReference(getNode_HasAttr(), this.getAttribute(), null, "hasAttr", null, 0, -1, Node.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
